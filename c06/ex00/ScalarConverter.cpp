...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/23 18:33:23 by renstein          #+#    #+#             */
/*   Updated: 2023/11/23 18:34:10 by renstein         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ScalarConverter::convert(std::string const & literal)
{
	...
	if (literal.length() == 1 && std::isprint(literal[0]) && !std::isdigit(literal[0])) //for char
	{
